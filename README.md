...
> **Надежность сборки:** Dockerfile включает автоматические повторы (до 5 попыток) при генерации Prisma клиента для обеспечения надежной сборки даже при нестабильном интернет-соединении. Все системные зависимости устанавливаются автоматически.
